...
const HEART_DIR = path.resolve(__dirname, '..', '..', 'anytype-heart');
const SERVICE_PROTO = path.join(HEART_DIR, 'pb/protos/service/service.proto');
const SERVICE_TS = path.join(__dirname, '..', 'src/ts/lib/api/service.ts');
