...
export default [
	...
	{ style: I.TextStyle.Header3, text: `Also, small features were implemented:` },
	...
	{ style: I.TextStyle.Bulleted, text: `Powertool <span class="${sc}">/</span> and mention <span class="${sc}">@</span> menu auto-closing when continue typing with no results.` },
	...
	{ style: I.TextStyle.Header3, text: `And sneaky bugs fixed:` },
