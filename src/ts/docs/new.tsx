...
export default [
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: '<i class="note">29 May 2020</i></br>' },
	{ type: I.BlockType.Div, id: I.DivStyle.Dot },
	{ type: I.BlockType.Text, style: I.TextStyle.Header1, text: '</br></br>Meet the new navigation' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: 'We decide to reduce the clutter in our heads and make navigation organic to your brain. You can now use <img src="./img/help/nav1.svg" style="height:20px;margin-bottom:-4px;"> sign on top to see links between pages and navigate on them. For faster usage, you can press <bgcolor class="bgColor bgColor-grey" data-param="grey"><color class="textColor textColor-red"data-param="red">Cmd + S</color></bgcolor> and search the right page by name or first sentence.</br>' },
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: '</br><b>Now you can stop segment and limiting your thoughts, just link the pages and flesh everything out how you really think. </b></br>' },
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: '<i class="note">6 May 2020</i></br>' },
	{ type: I.BlockType.Div, id: I.DivStyle.Dot },
	{ type: I.BlockType.Text, style: I.TextStyle.Header1, text: '</br></br>Introducing Anytype' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: '<font style="background-color: #fef9cc;">Anytype now is ready for your personal usage.</font>' },
