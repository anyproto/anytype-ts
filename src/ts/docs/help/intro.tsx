...
export default [
	...
	{ text: `<video src="./img/help/intro/relations-create-new-inline.mp4" preload controls class="full" />` },
	...
	{ text: `<video src="./img/help/intro/relations-inline.mp4" preload controls class="half" />`, align: I.BlockAlign.Center},
	...
	{ text: `<video src="./img/help/intro/relations-store.mp4" preload controls class="full" />` },
