...
export default [
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + N</b> to create new page on a dashboard.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + O</b> to open navigation pane.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + S</b> to open search pane.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + P</b> to print the page.' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + /</b> to initialise turn into menu.' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + C</b> to copy selected block/blocks or text part.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + P</b> to paste data outside Anytype, block/blocks or text part.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + X</b> to cut selected block/blocks or text part.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + ↑</b> to move to the start of the page, Press <b>Cmd</b> or <b>Ctrl + ↓</b> to move to the end of the page.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + A</b> to select all text in the block, twice all the blocks in page' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Press <b>Cmd</b> or <b>Ctrl + D</b> to duplicate selected block/blocks  or text part.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Hold down <b>Shift + ↑ </b> or <b> ↓</b> to expand your selection up or down. ' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'With text selected, press <b>Cmd</b> or <b>Ctrl + B</b> to make the <b>text bold</b>.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'With text selected, press <b>Cmd</b> or <b>Ctrl + I</b> to <i>italicize text</i>.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'With text selected, press <b>Cmd</b> or <b>Ctrl + Shift + S</b> for <s>strikethrough</s>.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'With text selected, press <b>Cmd</b> or <b>Ctrl + L</b> to add a link. You can also paste a URL over selected text to turn it into a link using <b>Cmd</b> or <b>Ctrl + V</b>.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'With text selected, press <b>Cmd</b> or <b>Ctrl + K</b> for inline code.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Header2, text: 'Markdown' },
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: 'At the beginning of any new line or existing block of content, try to type any of these options:' },
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Write command <b>/image</b> will bring up the <b>Option</b> or <b>Alt</b> to upload an image.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Write command <b>/video</b> lets you upload a video file.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Write command <b>/file</b> lets you upload any file from your computer.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Write command <b>/code</b> creates a code block where you can write a snippet of code.' },
	{ type: I.BlockType.Text, style: I.TextStyle.Bulleted, text: 'Write command <b>/duplicate</b> creates a copy of the current block.' },
