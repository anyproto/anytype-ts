...
export default [
	...
	text(`For all of you who’ve longingly admired the various setups others have shared in our community showcase, or for those of you who’ve created incredible setups of your own that you’ve wished to share, the wait is over.`),
	text(`Introducing: The ANY Experience gallery, a marketplace of use cases, templates, and setups where any member of our community can upload their own experience, or import an experience created by others. To browse the gallery, click here[link] (we’ve kickstarted the process with a few experiences of our own). If you’d like to contribute your own experience to the gallery, you can follow the instructions here[link].`),
