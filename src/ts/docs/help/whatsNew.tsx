...
export default [
	...
	{ style: I.TextStyle.Title, text: `Updates for 21 June, 2021` },
	...
	{ style: I.TextStyle.Bulleted, text: `Support for <span class="${sc}">Inline</span> code and formatting when typing with the keyboard. <span class="${sc}">** or __</span> - bold, <span class="${sc}">* or _</span> - italic <span class="${sc}">~~</span> - strike. Thanks, <a href="https://community.anytype.io/d/273-support-for-inline-code/1">Michael</a>!` },
