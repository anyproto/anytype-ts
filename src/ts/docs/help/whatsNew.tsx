...
export default [
	...
	{ text: `This release brings several improvements to cross-device syncing and reduces the amount of disk space needed. This version comes with a new data format for your pages. It is a huge step towards <b>collaboration</b>. Right now, however, it means your page history will use much less space, changes that you made in one device will come to another <b>online</b> without refresh.` },

	{ style: I.TextStyle.Header3, text: `🔔What’s changed?` },
	{ style: I.TextStyle.Bulleted, text: `You can now paste both files and images from the clipboard into Anytype blocks.` },
	...
	{ style: I.TextStyle.Bulleted, text: `Clipboard. From Anytype to Outside. Copying lists with nested items  <br>now saving its structure. ` },
	...
	{ style: I.TextStyle.Header3, text: `🧗Less distraction on mouse` },
	{ text: `You can work in navigation pane with keyboard keys:` },
	{ style: I.TextStyle.Bulleted, text: `Pages switching with arrows. <span class="${sc}">←</span> and <span class="${sc}">→</span> arrow transfers the selection to links, <br> <span class="${sc}">↑</span> and <span class="${sc}">↓</span> arrows transitions between within the same level, <span class="${sc}">Enter</span> — confirmation.` },
	{ style: I.TextStyle.Bulleted, text: `<span class="${sc}">Tab</span> & <span class="${sc}">Shift</span> + <span class="${sc}">Tab</span> can also be used to select objects. Works similar to the browser’s selection of elements.` },
	{ text: `Search pane` },
	{ style: I.TextStyle.Bulleted, text: `<span class="${sc}">↑</span> and <span class="${sc}">↓</span> arrows, <span class="${sc}">Tab</span> & <span class="${sc}">Shift</span> + <span class="${sc}">Tab</span> now make transition between options in the search menu without making additional filtration.` },
