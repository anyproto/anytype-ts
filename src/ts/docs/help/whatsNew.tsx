...
export default [
	...
	{ style: I.TextStyle.Bulleted, text: `In full-screen mode on Windows, the top panel will be hidden and shown automatically after moving a mouse to this area. Maximize button should make change the window to full-screen with the system bar. Full-screen is now accessible from the Window menu. Thanks, <a href="https://community.anytype.io/d/644-maximised-screen-acts-like-full-screen-mode/1">rdinamaztura</a>` },
