...
export default [
	...
	{ text: `You can expect longer sign in up to several minutes. It related to data structure optimisations that app needs to migrate on.` },
	...
	{ style: I.TextStyle.Bulleted, text: `You can new restore from Archive tab via three dots menu` },
	...
	{ style: I.TextStyle.Bulleted, text: `When you draged pictures into a toggle it became resized to the width of the toggle. Thanks, <a href="https://community.anytype.io/d/461-when-you-drag-pictures-into-a-toggle-it-resizes-to-the-width-of-the-toggle/1">Inkqb</a>.` },
	...
	{ style: I.TextStyle.Bulleted, text: `Pressing <span class="${sc}">Backspace</span> after using inline markdown at the beginning of the block was deleting both symbol and block style. Thanks, <a href="https://community.anytype.io/d/401-text-to-bullet-list-and-back/1">wemiprog</a>.` },
	{ style: I.TextStyle.Bulleted, text: `Inline markdown work optimisations. Speed of working was low for big blocks and carriage jumped futher after using a markdown symbol.` },
