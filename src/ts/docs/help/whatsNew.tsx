...
export default [
	...
	{ text: `Sets now have settings for icon, cover can have their own relations as in other objects.` },
	{ text: `From this release we start updating mentions after a title change. We will update this logic for Android in the next release.` },
	{ text: `Inbox now stores a list of objects without type, sorted by editing date.` },
	{ text: `Support for plain text in a code snippet. Thanks, <a href="https://community.anytype.io/d/317-support-for-plain-text-in-a-code-snippet/1">maxitg</a>` },
	{ text: `Add link creation via Markdown Syntax. Just write this anywhere in text block with format [text](link). Thanks, <a href="https://community.anytype.io/d/709-add-link-creation-via-markdown-syntax/1">alsmnn</a>` },
	{ text: `We added fast community feature request / bug report link instead of Typeform & link to knowledge baseю` },

	{ style: I.TextStyle.Header2, text: `Bugs we've fixed` },
	{ text: `Page restored from archive tab is still visible in archive tab. Thanks, <a href="https://community.anytype.io/d/536-page-restored-from-archive-tab-is-still-visible-in-archive-tab">Aljosha Leusmann, …</a>` },
	{ text: `Delay to start a new block after hitting “enter”. Thanks, <a href="https://community.anytype.io/d/334-delay-to-start-a-new-block-after-hitting-enter/1">HLucas</a>` },
	{ text: `Sometimes updates of names on home stop arriving after opening and changing on the second device` },
	{ text: `Instable download crashes application. Thanks, <a href="https://community.anytype.io/d/654-instable-download-crashes-application/1">wemiprog</a>` },
	{ text: `Greek letter “ώ” is displayed incorrectly. Thanks, <a href="https://community.anytype.io/d/826-visual-greek-letter-w-is-displayed-incorrectly/1">CrossDrain</a>` },
	{ text: `Pasting text with / and @ at the end launched menus` },
	{ text: `The embedded text disappears from the toggle if you press enter in the open toggle` },
	{ text: `The arrow down key stopped working from 21st toggle in a row. Thanks, SHIZOXLIFE` },

	{ style: I.TextStyle.Header2, text: `Sets` },
	{ text: `Aggregated options become reset when select one option in Set.` },
	{ text: `Changing the option of the tag / status updated to others cells with a delay.` },
	{ text: `When you delete a relation from Set you still might had empty column in other views` },
	{ text: `DatePicker. Adding date from next month drop the value to December of 2020. Thanks, <a href="https://community.anytype.io/d/629-date-picker-defaulting-to-dec-2020-when-picking-certain-dates/1">Corsecharter</a>` },
	{ text: `DatePicker. The year in the date was changed incorrectly if there was a value set.` },
	{ text: `Unexpected behavior may trigger when clicking at the right side of object’s name in Set. Thanks, <a href="https://community.anytype.io/d/655-unexpected-behavior-when-clicking-input-fields/1">nizos</a>` },
