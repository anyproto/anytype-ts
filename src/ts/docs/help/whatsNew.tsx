...
export default [
	...
	{ style: I.TextStyle.Bulleted, text: `You can now drag and drop relations from the relations view to object's canvas.` },

	{ style: I.TextStyle.Header2, text: `Performance` },
	{ style: I.TextStyle.Bulleted, text: `We fixed a possible few seconds delay when pressing "enter" or "backspace" in text blocks. <a href="https://community.anytype.io/d/334-delay-to-start-a-new-block-after-hitting-enter/1">Thanks, HLucas, vincer, wemiprog, lynxlove, JGsource</a>` },
	{ style: I.TextStyle.Bulleted, text: `We optimised application start. The app loads Home way more faster. <a href="https://community.anytype.io/t/anytype-taking-2-5-minutes-to-get-past-the-logging-in-screen/2859">Thanks, lynxlove, Srinath</a>` },

	{ style: I.TextStyle.Header2, text: `Enhancements` },
	{ style: I.TextStyle.Bulleted, text: `Mnemonic is now displayed more explicitly in the first session.` },
	{ style: I.TextStyle.Bulleted, text: `Change view to non-popup when window's width is to small for popup width. <a herf="https://community.anytype.io/d/969-default-to-non-popup-view-when-windows-width-is-popuppages-width/1">Thanks, triangles</a>` },
	{ style: I.TextStyle.Bulleted, text: `Relation <span class="highlight">Done</span> will be added to new Views in Sets by default.` },
	{ style: I.TextStyle.Bulleted, text: `<span class="highlight">СTRL / CMD + N</span> now works to create a new object inside a Set.` },
	{ style: I.TextStyle.Bulleted, text: `<span class="highlight">Go back</span> in history now works within object in a modal view` },

	{ style: I.TextStyle.Header2, text: `Bugs` },
	{ style: I.TextStyle.Bulleted, text: `Closing and opening app might end with an error. <a href="https://community.anytype.io/t/closing-the-app-only-hides-the-foreground-app">Thanks, lynxlove</a>` },
	{ style: I.TextStyle.Bulleted, text: `After writing text in one block and clicking on another, the carriage did not move there.` },
	{ style: I.TextStyle.Bulleted, text: `Relation Object may stop changing order of it's values` },
	{ style: I.TextStyle.Bulleted, text: `<span class="highlight">Ctrl+X</span> discarded editing instead of cutting the selected content. <a href="https://community.anytype.io/t/ctrl-x-discards-editing/2276"> Thanks, thiago_nascimentodf</a>` },
	{ style: I.TextStyle.Bulleted, text: `Wallpaper was changing to default after log out` },
	{ style: I.TextStyle.Bulleted, text: `When you clicked on a Status, Tag, File, Object relation value 2 times, the focus wasn't removed from there` },
	{ style: I.TextStyle.Bulleted, text: `After a URL has been inserted into the URL relation, the content couldn't become selected. <a href="https://community.anytype.io/t/can-t-select-url-relation-with-mouse-keyboard-after-url-has-been-added">Thanks, Sharky</a>` },
	{ style: I.TextStyle.Bulleted, text: `Column position change in darkmode remained with the default styles.` },
	{ style: I.TextStyle.Bulleted, text: `Formatting in code block was enabled. a * b * (c + d) became: a b (c + d). <a href="https://community.anytype.io/t/formatting-in-code-block-should-be-disabled">Thanks, nelatmani</a>` },
	{ style: I.TextStyle.Bulleted, text: `Multi-select checkbox overlapped object title` },
	{ style: I.TextStyle.Bulleted, text: `Multiple selection state got cleared after using Tab search in Home. <a href="https://community.anytype.io/t/search-clears-after-selecting-in-history-tab">Thanks, kEbZeCK</a>` },
	...
	{ style: I.TextStyle.Bulleted, text: `Searching inside the object didn't find matches in <span class="highlight">link to the object</span> block` },
	{ style: I.TextStyle.Bulleted, text: `There was no ability to open Home from navigation` },
	{ style: I.TextStyle.Bulleted, text: `In filters after a change of a relation <span class="highlight">Done</span> to relation <span class="highlight">Date</span> with <span class="highlight">is checked</span> condition, a crash might occur` },
	{ style: I.TextStyle.Bulleted, text: `When created a new <span class="highlight">Tag</span> or <span class="highlight">Status</span> value, a new one haven't been added by hitting <span class="highlight">Enter</span>` },
	...
	{ style: I.TextStyle.Bulleted, text: `Line spacing could be different for the first heading compared to the other headings. <a href="https://community.anytype.io/t/weird-line-space-behavior-with-titles">Thanks, Liam8lu</a>` },
