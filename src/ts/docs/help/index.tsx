...
const Index = [
	...
	{ 
		type: I.BlockType.Text, style: I.TextStyle.Paragraph, 
		text: `In this version, all the data becomes encrypted and syncs with our servers. You can restore the latest snapshot at any moment even if your device is offline, but it is an experimental feature. The 100% working way for data backup is to manually copy and save Anytype's data folder, you can find it here <span id="button-path" class="cp bgColor bgColor-grey textColor textColor-red">${path}</span>.` 
	},
	{ 
