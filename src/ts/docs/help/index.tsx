...
const Index = [
	...
	{ type: I.BlockType.Text, style: I.TextStyle.Paragraph, text: 'Your data is self-hosted. It`s mean that all the information is stored on your computer. You can use Anytype for free without any storage or upload limits.' },
