...
const BlockLinkImage = observer(class BlockLinkImage extends React.Component<I.BlockComponent> {
    ...
    render() {
        ...
        const hash = block.content.targetBlockId;
        const state = I.FileState.Done

                // add props missing like src
                const updatedProps = {
                    ...this.props,  
                    src: 'votre_source'
                };
