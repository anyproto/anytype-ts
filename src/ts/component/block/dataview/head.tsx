...
const Head = observer(
	class Head extends React.Component<I.ViewComponent, State> {
			...
			return (
				...
				>
					<Editable
						...
						placeholder={UtilObject.defaultName(
							isCollection ? 'Collection' : 'Set'
						)}
		...
		setValue() {
			...
			if (
				name == UtilObject.defaultName('Page') ||
				name == UtilObject.defaultName('Set')
			) {
				name = '';
			}
		...
		save() {
			...
			if (
				value == UtilObject.defaultName('Page') ||
				value == UtilObject.defaultName('Set')
			) {
				value = '';
			}
