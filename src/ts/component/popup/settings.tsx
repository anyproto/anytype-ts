...
import { Icon, Button, Title, Label, Cover, Textarea, Loader, IconEmoji, Error, Pin } from 'ts/component';
				...
				content = (
					<div>
						...
						<div className="path">
							...
							<IconEmoji icon=":gear:" /> Settings & Members → <IconEmoji icon=":house:" /> Settings → Export all workspace content → <br/>
							Export format : "Markdown & CSV".
						</div>

						<div className="path">
							<b>{translate('popupSettingsImportPageTitle')}</b><br/>
							Three dots menu on the top-left corner → <IconEmoji icon=":paperclip:" /> Export →  <br/> Export format : "Markdown & CSV".
						</div>
