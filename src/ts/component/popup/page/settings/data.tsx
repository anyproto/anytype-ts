...
const PopupSettingsPageDataManagement = observer(
	class PopupSettingsPageStorageIndex extends React.Component<Props, {}> {
		...
		render() {
			...
			const localStorage = {
				name: translate('popupSettingsDataLocalFiles'),
			...
			return (
				<React.Fragment>
					...
					<Label
						...
						text={translate(
							'popupSettingsDataManagementLocalStorageText'
						)}
					/>
					...
					<div className="actionItems">
						<div className="item storageUsage">
							...
							<div className="side right">
								<Button
									...
									className="c28"
									text={translate(
										'popupSettingsDataManagementOffloadFiles'
									)}
						...
						{canMove ? (
							<div
								id="row-location"
								className="item accountLocation"
								onClick={this.onLocationMove}
							>
								<Label
									text={translate(
										'popupSettingsAccountMoveTitle'
									)}
								/>
								<Label
									className="locationLabel"
									text={
										walletPath == accountPath
											? 'Default'
											: 'Custom'
									}
								/>
		...
		onLocationMove() {
			...
			const accountPath = localStoragePath.replace(
