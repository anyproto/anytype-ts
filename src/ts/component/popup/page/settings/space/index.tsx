	...
	> {
		...
		render() {
			...
			const progressSegments = (spaces || [])
				.map(space => {
					const object: any =
						commonStore.spaceStorage.spaces.find(
				...
				.filter(it => it);
			const isRed =
				bytesUsed / bytesLimit >= 0.9 || localUsage > bytesLimit;
			...
			if (isRed) {
				...
				extend = (
					<Label
						text={translate(
							`popupSettingsSpaceIndexRemoteStorageExtend`
						)}
						...
						<div className="headerContent">
							<div className="name">
								<Label
									className="small"
									text={translate(
										'popupSettingsSpaceIndexSpaceNameLabel'
									)}
								/>
								<Input
							...
							<div className="sectionContent">
								<div className={usageCn.join(' ')}>
									...
									<ProgressBar
										...
										current={UtilFile.size(bytesUsed)}
										max={UtilFile.size(bytesLimit)}
									/>
								</div>
							...
							<div className="sectionContent">
								...
								<div
									...
									onClick={() =>
										UtilCommon.copyToast(
											translate(
												'popupSettingsAccountAnytypeIdentityAccountId'
											),
											account.id
										)
									}
