...
const PopupSettingsSpaceTeam = observer(
	class PopupSettingsSpaceTeam extends React.Component<I.PopupSettings> {
		node: any = null;
		team: any[] = [];
		cache: any = null;
		top = 0;
		...
		render() {
			...
			const memberOptions = [
				{
					id: 'reader',
					name: translate('popupSettingsSpaceMemberTypeReader'),
				},
				{
					id: 'editor',
					name: translate('popupSettingsSpaceMemberTypeEditor'),
				},
				{
					id: 'admin',
					name: translate('popupSettingsSpaceMemberTypeAdmin'),
				},
				{ id: '', name: '', isDiv: true },
				{
					id: 'remove',
					name: translate('popupSettingsSpaceTeamRemoveMember'),
					icon: 'remove',
				},
			];
				...
				<div ref={node => (this.node = node)}>
					...
					<Title
						text={UtilCommon.sprintf(
							translate('popupSettingsSpaceTeam'),
							space.name
						)}
					/>
					<Label
						className="counter"
						text={UtilCommon.sprintf(
							translate('popupSettingsSpaceTeamMembers'),
							length
						)}
					/>
					...
					<div className="buttons">
						<Button
							className="c36"
							onClick={() => onPage('spaceInvite')}
							text={translate('popupSettingsSpaceTeamButton')}
						/>
					</div>
				</div>
			);
