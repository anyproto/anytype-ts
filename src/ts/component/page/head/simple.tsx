...
const HeadSimple = observer(
	class Controls extends React.Component<Props> {
		...
		render(): any {
			...
			const allowDetails = blockStore.checkFlags(rootId, rootId, [
			...
			const isTypeOrRelation = UtilObject.isTypeOrRelationLayout(
				object.layout
			);
			const isRelation = UtilObject.isRelationLayout(object.layout);
			const canEditIcon =
				allowDetails && !UtilObject.isRelationLayout(object.layout);
		...
		componentDidUpdate() {
			...
			if (
				!focused &&
				!object._empty_ &&
				object.name == UtilObject.defaultName('Page')
			) {
