...
const HeaderMainObject = observer(
	class HeaderMainObject extends React.Component<I.HeaderComponent, State> {
		...
		render() {
			const { rootId, onSearch, onTooltipShow, onTooltipHide, isPopup } =
				this.props;
			...
			if (object.isArchived) {
			...
			} else if (UtilObject.isTemplate(object.type)) {
				center = (
					<HeaderBanner
				...
				center = (
					<HeaderBanner
						type={I.BannerType.TemplateSelect}
						object={object}
						count={templatesCnt + 1}
						isPopup={isPopup}
					/>
				);
			} else {
