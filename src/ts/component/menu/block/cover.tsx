		...
		switch (this.tab) {
			...
			case Tab.Library: {
				const filters: I.Filter[] = [
					...
					{ relationKey: 'widthInPixels', condition: I.FilterCondition.GreaterOrEqual, value: 1000 },
					{ relationKey: 'heightInPixels', condition: I.FilterCondition.GreaterOrEqual, value: 300 },
				];
				const sorts = [ 
