...
const MenuRelationSuggest = observer(class MenuRelationSuggest extends React.Component<I.Menu, State> {
	...
	load (clear: boolean, callBack?: (message: any) => void) {
		...
		const filters: any[] = [
			...
			{ operator: I.FilterOperator.And, relationKey: 'type', condition: I.FilterCondition.In, value: [ Constant.typeKey.relation, Constant.storeTypeKey.relation ] },
		...
		switch (item.id) {
			case 'store': {
				...
				const filters: I.Filter[] = [
					...
					{ operator: I.FilterOperator.And, relationKey: 'type', condition: I.FilterCondition.Equal, value: Constant.storeTypeKey.relation },
