			...
			sections = sections.concat([
				...
				},
				{
					children: [
						...
						canCalculate ? { id: 'calculate', icon: Relation.registryIconName(I.RelationType.Number), name: translate('commonCalculate'), arrow: true } : null,
					]
				},
			]);
		};
	...
	return (
		...
		>
			...
			<div className={[ 'section', (!opts && !isReadonly ? 'noLine' : '') ].join(' ')}>
				...
				<MenuItemVertical 
					id="relation-type" 
					icon={format === null ? undefined : Relation.registryIconName(format)}
