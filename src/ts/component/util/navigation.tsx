	...
	class Navigation extends React.Component {
		...
		render() {
			...
			const buttons: any[] = [
				...
				{
					id: 'plus',
					tooltip: translate('navigationCreateNew'),
					caption: `${cmd} + N / ${alt} + Shift + N`,
					onClick: this.onAdd,
					onContextMenu: () => keyboard.onQuickCapture(),
				},
				{
					id: 'graph',
		...
		rebind() {
			this.unbind();
			$(window).on('resize.navigation sidebarResize.navigation', () =>
				this.resize()
			);
		}
