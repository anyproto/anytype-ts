...
const Expand = (props: React.SVGProps<SVGSVGElement>) => (
	<svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
		...
		<path fillRule="evenodd" clipRule="evenodd" d="M3.46961 15.7196L8.46961 10.7196L9.53027 11.7803L4.53027 16.7803L3.46961 15.7196Z" fill="currentColor" />
		<path d="M9 16.5C9 16.9142 8.66421 17.25 8.25 17.25H3V15.75H8.25C8.66421 15.75 9 16.0858 9 16.5Z" fill="currentColor" />
		<path d="M3.75 11.25C4.16421 11.25 4.5 11.5858 4.5 12L4.5 17.25H3L3 12C3 11.5858 3.33579 11.25 3.75 11.25Z" fill="currentColor" />
	</svg>
);
