...
export function PopupConfirmInviteIcon({ size, color: _color }: IconSvgProps) {
	return (
		<svg aria-hidden="true" width={size} height={size} viewBox="0 0 56 56" fill="none">
			...
			<path d="M7.00001 48.001L24 31.001" stroke="#2AA7EE" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M3 38.001L14 27.001" stroke="#2AA7EE" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
			<path d="M17 52.001L28 41.001" stroke="#2AA7EE" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
		</svg>
	);
}
