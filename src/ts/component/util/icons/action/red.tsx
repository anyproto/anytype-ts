...
export function RedIcon({ size, color }: IconSvgProps) {
	return (
		<svg aria-hidden="true" width={size} height={size} viewBox="0 0 120 121" fill="none">
			<g clipPath="url(#clip0_1048_18449)">
			...
			<defs>
				...
				<clipPath id="clip0_1048_18449">
					<rect width="120" height="120" fill={color} transform="translate(0 0.273438)"/>
				</clipPath>
			</defs>
		</svg>
	);
