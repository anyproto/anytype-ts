...
registerIcon('menu/block/common/collection', Collection);
registerIcon('menu/block/common/existing', Existing);
registerIcon('menu/block/common/linkto', Linkto);
registerIcon('menu/block/common/relation', Relation);
