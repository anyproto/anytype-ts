...
class Block implements I.Block {
	...
	canHaveAlign (): boolean {
		return !this.isSystem() && (this.isLink() || this.isTextParagraph() || this.isTextQuote() || this.isTextHeader() || this.isFileImage() || this.isFileVideo() || this.isLatex() || this.isFilePdf());
	};
