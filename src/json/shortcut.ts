			...
			children: [
				{
					name: translate('popupShortcutBasics'), children: [
						...
						{ id: 'closeTab', name: translate('popupShortcutMainBasicsCloseTab'), keys: [ cmdKey, 'w' ] },
						...
						{ id: 'pinTab', name: translate('popupShortcutMainBasicsPinTab'), keys: [] },
...

				{
					name: translate('popupShortcutNavigation'), children: [
						...
						{ id: 'globalSearch', name: translate('popupShortcutNavigationGlobalSearch'), keys: [ cmdKey, 'shift', 'space' ] },
						...
						{ name: translate('popupShortcutMainBasicsOpenInNewWindow'), keys: [ cmdKey, 'shift', 'click' ] },
					]
				},
				...
				{ 
					name: translate('popupShortcutEditor'), children: [
						...
						{ name: translate('popupShortcutNavigationPage6'), keys: isMac ? [ cmdKey, 'arrowup' ] : [ 'ctrl', 'home' ] },
						{ name: translate('popupShortcutNavigationPage7'), keys: isMac ? [ cmdKey, 'arrowdown' ] : [ 'ctrl', 'end' ] },
