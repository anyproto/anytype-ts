			...
			this.stop().then(() => {
				...
				this.cp.on('exit', () => {
					...
					dialog.showErrorBox(
						...
						'You will be redirected to the crash log file. You can send it to Anytype developers by creating issue at community.anytype.io'
					);
