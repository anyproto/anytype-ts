		...
		(n.forceCollide = function (n) {
			...
			function h() {
				for (var n, i, h, y, d, g, x, s = e.length, p = 0; p < l; ++p)
					for (
						i = t.quadtree(e, o, f).visitAfter(v), n = 0;
						n < s;
						++n
					)
						(h = e[n]),
				...
				function M(n, t, e, r, i) {
					var o = n.data,
						...
						l = g + f;
					if (!o)
						return t > y + l || r < y - l || e > d + l || i < d - l;
					if (o.index > h.index) {
						var v = y - o.x - o.vx,
							s = d - o.y - o.vy,
							p = v * v + s * s;
			...
			function x() {
				if (r) {
					...
					for (i = 0, o = new Array(a); i < l; ++i)
						((u = n[i]).index = i),
							'object' != typeof u.source &&
								(u.source = c(v, u.source)),
							'object' != typeof u.target &&
								(u.target = c(v, u.target)),
					...
					for (i = 0, f = new Array(l); i < l; ++i)
						(u = n[i]),
							(f[i] =
								o[u.source.index] /
								(o[u.source.index] + o[u.target.index]));
