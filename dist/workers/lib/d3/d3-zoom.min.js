				...
				t.on('start.zoom', function () {
					...
					.tween('zoom', function () {
						var t = this,
							...
							f = Y(
								c.invert(s).concat(a / c.k),
								l.invert(s).concat(a / l.k)
							);
						return function (t) {
							if (1 === t) t = l;
							else {
				...
				if (_.apply(this, arguments)) {
					var n = S(this, e).event(t),
						...
						u = Math.max(
							...
							Math.min(
								T[1],
								o.k * Math.pow(2, w.apply(this, arguments))
							)
						),
						s = i.pointer(t);
					if (n.wheel)
					...
					f(t),
						...
						n.zoom(
							'mouse',
							k(j(B(o, u), n.mouse[0], n.mouse[1]), n.extent, M)
						);
				}
				function h() {
					(n.wheel = null), n.end();
